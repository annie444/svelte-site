...
<svg 
  ...
  class="fixed" style="left: {$left}px; top: {$top}px;" 
...
>
  ...
  <circle
    ...
    r="{circleDims}" 
  />
  <circle style="transform: translate({xMove}px, {yMove}px);" class="pointer-events-none" fill="url('#top-left-circle')" cx="{circleDims}" cy="{circleDims}" r="{circleDims}" />
</svg>
